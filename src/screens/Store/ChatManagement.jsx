...
import {getChatSummary, getChatSummaryStore} from '../../api/MessageApi';

function ChatManagement({navigation}) {
  ...
  const getAdminData = async () => {
    const res = await getCurrentUserData({
      userId: 'tMiEpYMtslXzeL9rftVx2mB5pxT2',
    });
  ...
  return (
    <SafeAreaView style={{backgroundColor: CUSTOM_COLOR.White, flex: 1}}>
      ...
      <UserChat
        key={adminData._id}
        source={adminData.avatar}
        name={'Admin tổng'}
        time={'Có thể trò chuyện ngay'}
        notification={0}
        justCreate={true}
        onPress={() => {
          navigation.navigate('DetailMessage', {item: adminData});
        }}
      />
            ...
            return (
              <UserChat
                ...
                onPress={() => {
                  ...
                  navigation.navigate('DetailMessage', {item});
                }}
                ...
                justCreate={!item.latestMessage ? true : false}
              />
            );
          }}
