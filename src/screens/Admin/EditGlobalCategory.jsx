...
import { updateGlobalCategory } from '../../api/GlobalCategoryApi';

function EditGlobalCategory({ route, navigation }) {
  ...
  const setData = async () => {
    ...
    const res = await updateGlobalCategory({id: category._id, data: dataCategory});
    if (res.status === 200) {
...
export default EditGlobalCategory;
