...
import { addGlobalCategory } from '../../api/GlobalCategoryApi';

function AddGlobalCategory({ navigation }) {
  ...
  const setData = async () => {
    ...
    const res = await addGlobalCategory({ data: dataCategory });
    if (res.status === 200) {
    } else {
      console.log(res);
          ...
          <View style={[styles.inputContainer, { height: 90 }]}>
            ...
            <View style={{ flex: 1, flexDirection: 'row' }}>
              <View
                ...
                <Text style={styles.titleInputStyle}>Name Of Global Category</Text>
                <Text
                  style={[
